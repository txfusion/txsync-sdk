...
const _abi = [
  ...
  {
    inputs: [],
    name: "calculatePaymasterCreationRequiredETH",
    outputs: [
      {
        internalType: "uint256",
        name: "",
  ...
  },
  {
    ...
    name: "deployedPaymasters",
    outputs: [
      {
        internalType: "enum Factory.PaymentMethod",
        name: "method",
        type: "uint8",
      },
      {
    ...
    outputs: [
      {
        ...
        internalType: "struct Factory.TsukoItem[]",
        name: "",
        type: "tuple[]",
      },
    ],
  ...
  },
  {
    inputs: [
      ...
      {
        internalType: "uint256",
        name: "_paymasterCreationPriceInUSD",
        type: "uint256",
      },
    ],
    name: "initialize",
  ...
  {
    inputs: [],
    name: "paymasterCreationPriceInUSD",
    outputs: [
      {
        internalType: "uint256",
        name: "",
  ...
  },
  {
    ...
    name: "updatePaymasterCreationPriceInUSD",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
  ...
  },
  {
    ...
    name: "updateTokenWhitelistStatus",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
